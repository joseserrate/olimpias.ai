...
export const AppleHero: React.FC = () => {
  return (
    <section className="relative min-h-[95vh] flex items-center bg-white overflow-hidden">
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 lg:px-8 pt-24 pb-20 md:pt-32 md:pb-24">
        <div className="max-w-[980px] mx-auto text-center">
          {/* Main Headline - Apple refined size */}
          <h1 className="text-[40px] sm:text-[48px] md:text-[56px] lg:text-[64px] font-semibold text-[#0B0B0D] mb-6 leading-[1.07] tracking-[-0.015em]">
          ...
          <p className="text-[19px] md:text-[21px] lg:text-[24px] text-[#4A4A50] mb-8 max-w-[800px] mx-auto leading-[1.38] font-normal">
          ...
          {/* Supporting Line */}
          <p className="text-[17px] text-[#7A7A82] max-w-[600px] mx-auto leading-[1.47] mb-16 font-normal">
            Donde Bolivia diseña y gobierna agentes de inteligencia artificial para rendimiento empresarial.
          </p>
          
          {/* Trust Line */}
          <div className="pt-12 border-t border-[#E6E6EA] max-w-[700px] mx-auto">
            <p className="text-[12px] text-[#7A7A82] tracking-wide leading-[1.67]">
